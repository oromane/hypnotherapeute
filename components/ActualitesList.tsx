...
export function ActualitesList({ initialArticles, initialFeatured, initialCategories }: ActualitesListProps) {
    const [articles] = useState<Article[]>(initialArticles)
    const [featuredArticles] = useState<Article[]>(initialFeatured)
